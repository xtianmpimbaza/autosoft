...
//////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function insert_into_students($student_id, $first_name, $last_name, $date_of_birth, $class, $mum_name, $dad_name,
                                         ...
                                         $religion, $tribe, $home_adress, $current_adress, $previous_agregate, $previous_class, $house)
    {
        ...
        $mDatabaseQueryProcessor = new DatabaseQueryProcessor();
        $table = "`students`";
        $columns = "`student_id`,`first_name`,`last_name`,`date_of_birth`,`class`,`mum_name`,`dad_name`,`previous_school`,`school_awareness_mode`,
                    `years_expected`,`admition_date`,`today`,`sponsor`,`religion`,`tribe`,`home_adress`,`current_adress`,
                    `previous_agregate`,`previous_class`,`house`";
        $values = "'$student_id','$first_name','$last_name','$date_of_birth','$class','$mum_name','$dad_name','$previous_school','$school_awareness_mode',
                    '$years_expected','$admition_date','$today','$sponsor','$religion','$tribe','$home_adress','$current_adress',
                    '$previous_agregate','$previous_class','$house'";
    ...
    public function insert_into_subject($sub_id, $sub_name, $sub_type, $priority)
    {
//        echo $sub_id." ".$sub_name." ".$sub_type." ".$priority;
        $util_obj = new Utilties();
        $mDatabaseQueryProcessor = new DatabaseQueryProcessor();
        $table = "subjects";
        $columns = "`subject_id`,`subject_name`,`subject_type`,`subject_priority`";
        $values = "'$sub_id','$sub_name','$sub_type','$priority'";

        return $util_obj->insert_into($mDatabaseQueryProcessor, $table, $columns, $values);
    }
 public function insert_into_grade($sub_id, $sub_name, $sub_type)
    {
//        echo $sub_id." ".$sub_name." ".$sub_type." ".$priority;
        $util_obj = new Utilties();
        $mDatabaseQueryProcessor = new DatabaseQueryProcessor();
        $table = "grades";
        $columns = "`grade_id`,`min_value`,`max_value`";
        $values = "'$sub_id','$sub_name','$sub_type'";

        if ($util_obj->insert_into($mDatabaseQueryProcessor, $table, $columns, $values)){
            return "success";
        }else{
            return "Failed";
        }
    }
public function insert_into_marks($table, $year, $term, $student_id, $subject, $marks)
    {
//        echo $sub_id." ".$sub_name." ".$sub_type." ".$priority;
        $util_obj = new Utilties();
        $mDatabaseQueryProcessor = new DatabaseQueryProcessor();
        $columns = "`year`,`term`,`student_id`,`subject`,`score`";
        $values = "'$year','$term','$student_id','$subject','$marks'";
